"""
Django settings for xingoligor project.
...
WSGI_APPLICATION = 'xingoligor.wsgi.application'
...
DEFAULT_FROM_EMAIL = config('EMAIL_HOST_USER', default='', cast=str)
